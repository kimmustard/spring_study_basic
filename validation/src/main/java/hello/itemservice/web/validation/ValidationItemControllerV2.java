...
public class ValidationItemControllerV2 {
	...
	//검증기를 찾아서 매번 적용해주는 역할을 한다. 이 컨트롤러에서만 적용된다.
	@InitBinder
	...
	public String addForm(Model model) {
		// 재사용이 가능할 수 있도록 비어있는 객체를 post /add 로 넘긴다.
...
//	@PostMapping("/add")
	public String addItemV1(@ModelAttribute Item item, BindingResult bindingResult,
		...
		/*
		 * BindingResult가 Errors Map을 대체한다. 그리고 BindingResult는 반드시 파라미터 @ModelAttribute
		 * Item item -> 뒤에 와야한다. BindingResult 자동으로 Model에 값을 넣어준다.
		 */
